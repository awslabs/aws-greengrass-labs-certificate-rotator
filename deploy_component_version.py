...
Example execution:
python3 deploy_component_version.py 1.2.0 GreengrassEC2DeviceFarm
"""
...
parser.add_argument('version', help='Version of the component to be deployed (Example: 1.2.0)')
